...
export const blogPosts: BlogPost[] = [
  {
    ...
    date: '2026-02-02',
    description:
      'How I built a Moltworker-powered personal AI agent that generates blog ideas grounded in my own writing.',
  ...
  },
  {
    ...
    date: '2025-10-11',
    description:
      'Building an automated solution to permanently track repository clones using GitHub Actions, Gist, and Shields.io',
